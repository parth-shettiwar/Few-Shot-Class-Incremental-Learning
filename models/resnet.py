...
class Generator(nn.Module):
    def __init__(self, norm=False, latent_dim=200, class_dim=200, feat_dim=2048, hidden_dim=2048,num_class=10):
        super(Generator, self).__init__()
        self.latent_dim = feat_dim + num_class
...
class Discriminator(nn.Module):
    def __init__(self, feat_dim=2048, class_dim=200, hidden_dim=2048,latent_dim=200, condition='projection'):
...
class ResNet_ImageNet(nn.Module):
    def __init__(self, block, num_blocks, pretrained=True, norm=False, Embed=True, feat_dim=512, embed_dim=512):
    ...
    def forward(self, x):
        ...
        # out_features = self.embed(out_features)  
